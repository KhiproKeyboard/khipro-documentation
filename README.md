...
2. পৃথায়ক ব্যবহার করে লেখাকে ছিন্নায়িত বা অংশায়িত করা যায়।  
এটা সফটওয়্যারকে বুঝে নিতে বাধ্য করে যে, পৃথায়কের আগের ও পরের অংশদ্বয় বিচ্ছিন্ন। যেমন:  
`ami;i` = `আমিই`  
`jh` = `ঝ` &emsp; `j;h` = `জহ`  
`ae` = `অ্যা` &emsp; `a;e` = `আএ`  
`ii` = `ঈ` &emsp; `i;i` = `ইই`  
...
`লিখতে` = `likhte`  
4. একটা শব্দে যতবার ইচ্ছা পৃথায়ক ব্যবহার করা যাবে।
...
ক্ষিপ্রতে একাধিক মডিফায়ার key রয়েছে। একটি হলো `f` যাকে প্রয়োজনে `⁌` রূপে দেখানো হয়; এবং অপরটি **স্ল্যাশ** `/`।
...
- সাধারণভাবে, শব্দের শুরুতে, এবং স্বরের পরে উপরের ম্যাপিংগুলো দিয়ে স্বরবর্ণ তৈরি হবে; কিন্তু ব্যঞ্জনধ্বনির পরে লিখলে স্বরবর্ণ তৈরি না হয়ে কারচিহ্ন তৈরি হবে।   
...
- উপরের ফিচারটি কখন কাজে লাগবে? যখন শব্দের মাঝে ভুলে যাওয়া কারচিহ্ন বসানো লাগে, কিংবা কোথাও শুধু কারচিহ্ন দেখানো লাগে, তখন।
...
- [সাধারণ স্বরবর্ণের নিয়মগুলো]() এগুলোর ক্ষেত্রেও কাজ করবে; অর্থাৎ, এগুলোকেও মডিফায়ার চেপে আন্তঃরূপান্তর করা যাবে।  
এদের ৪টির মধ্যে ৩টির পূর্ণরূপের পাশাপাশি সংক্ষিপ্তরূপও রাখা হয়েছে।
